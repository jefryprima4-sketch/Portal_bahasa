...
export default async function CreateCoursePage() {
  ...
  const backPath = profile?.role === 'admin' ? '/admin/courses' : '/instructor/courses';

  return (
    <div className="p-8 lg:p-12 space-y-10 max-w-4xl mx-auto font-body">
      <section className="space-y-1">
        <a href={backPath} className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-primary hover:underline group mb-2">
        ...
        <p className="text-on-surface-variant font-medium">Siapkan kelas baru untuk mahasiswa Anda.</p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 bg-white rounded-[2rem] whisper-shadow border border-slate-50 p-8 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-headline font-bold text-slate-900">Informasi Umum</h3>
          </div>
          <form action={createCourse} className="space-y-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                placeholder="Jelaskan tujuan pembelajaran, target mahasiswa, dan garis besar materi..."
              />
            </div>
            <div className="pt-2">
        ...
        <div className="space-y-6">
          <div className="bg-primary text-white p-6 rounded-[2rem] shadow-xl space-y-4">
            ...
            <h4 className="font-headline font-bold text-lg">Tips Membuat Kursus</h4>
            <p className="text-xs opacity-90 leading-relaxed">
              Kursus yang baik memiliki judul yang spesifik dan deskripsi yang jelas tentang apa yang akan didapatkan mahasiswa setelah selesai mengikuti kelas ini.
            </p>
          </div>
          ...
          <div className="bg-slate-50 p-4 rounded-[1.5rem] border border-slate-100">
            <div className="flex gap-3">
              ...
              <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                Setelah kursus dibuat, Anda dapat melanjutkan untuk menambahkan materi PDF, rekaman audio listening, dan kuis pilihan ganda.
              </p>
            </div>
          </div>
        </div>
